...
c.sync=function(a,b,d){var c;c={};if(!d.data&&b&&("create"===a||"update"===a))c["Content-Type"]="application/json",d.data=JSON.stringify(b.toJSON());a=i.state.connector.perform(h[a],f(b),d.data,c);a.then(d.success,d.error);return a};module.exports=Backbone}).call(this);
